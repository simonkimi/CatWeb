...
final autoCompleteParser = AutoCompleteParser(
  name: '自动补全',
  uuid: genUuid(),
  ...
  itemComplete: const Selector(
    selector: '',
    script: ScriptField(
      script: r"""function hook(n){var t=JSON.parse(n),l=null!=t.mtn?t.mtn:t.tn,m=null!=t.mns?t.mns:t.ns;return-1!=l.indexOf(" ")&&(l='"'+l+'$"'),m+":"+l}""",
  ...
  itemSubtitle: const Selector(
    selector: '',
    script: ScriptField(
      script: r'''function hook(n){var r=JSON.parse(n);return"temp"==r.ns?"=> "+r.mns+":"+r.mtn:""}''',
      type: ScriptFieldType.js,
    ),
  ),
);
