...
const SiteBlueprint$json = const {
  ...
  '2': const [
    ...
    const {'1': 'login_cookie_reg', '3': 4, '4': 1, '5': 9, '10': 'loginCookieReg'},
    const {'1': 'login_cookie_description', '3': 5, '4': 1, '5': 9, '10': 'loginCookieDescription'},
    ...
    const {'1': 'parsers', '3': 20, '4': 3, '5': 11, '6': '.ParserStore', '10': 'parsers'},
...
final $typed_data.Uint8List siteBlueprintDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use parserStoreDescriptor instead')
const ParserStore$json = const {
  '1': 'ParserStore',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.ParserType', '10': 'type'},
    const {'1': 'parser', '3': 2, '4': 1, '5': 12, '10': 'parser'},
  ],
};

/// Descriptor for `ParserStore`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List parserStoreDescriptor = $convert.base64Decode('CgtQYXJzZXJTdG9yZRIfCgR0eXBlGAEgASgOMgsuUGFyc2VyVHlwZVIEdHlwZRIWCgZwYXJzZXIYAiABKAxSBnBhcnNlcg==');
...
const CookieJarMessage$json = const {
  '1': 'CookieJarMessage',
  '2': const [
    const {'1': 'cookies', '3': 1, '4': 3, '5': 11, '6': '.CookieJarMessage.SerializableCookie', '10': 'cookies'},
  ],
...
final $typed_data.Uint8List cookieJarMessageDescriptor = $convert.base64Decode('ChBDb29raWVKYXJNZXNzYWdlEj4KB2Nvb2tpZXMYASADKAsyJC5Db29raWVKYXJNZXNzYWdlLlNlcmlhbGl6YWJsZUNvb2tpZVIHY29va2llcxpNChJTZXJpYWxpemFibGVDb29raWUSHwoLY3JlYXRlX3RpbWUYASABKANSCmNyZWF0ZVRpbWUSFgoGY29va2llGAIgASgJUgZjb29raWU=');
