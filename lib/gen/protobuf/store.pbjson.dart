...
const SiteConfig$json = const {
  ...
  '2': const [
    ...
    const {'1': 'galleryParsers', '3': 20, '4': 3, '5': 11, '6': '.GalleryParser', '10': 'galleryParsers'},
    const {'1': 'listViewParser', '3': 21, '4': 3, '5': 11, '6': '.ListViewParser', '10': 'listViewParser'},
    const {'1': 'imageParsers', '3': 22, '4': 3, '5': 11, '6': '.ImageParser', '10': 'imageParsers'},
    const {'1': 'actionList', '3': 23, '4': 3, '5': 11, '6': '.ActionCombine', '10': 'actionList'},
    const {'1': 'pageList', '3': 24, '4': 3, '5': 11, '6': '.SitePage', '10': 'pageList'},
  ],
};

/// Descriptor for `SiteConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List siteConfigDescriptor = $convert.base64Decode('');
