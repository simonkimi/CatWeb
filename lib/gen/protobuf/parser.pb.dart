...
class ListViewParser extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(26)
  $0.Selector get target => $_getN(16);
  @$pb.TagNumber(26)
  set target($0.Selector v) {
    setField(26, v);
  }
  ...
  @$pb.TagNumber(26)
  $0.Selector ensureTarget() => $_ensure(16);

  @$pb.TagNumber(30)
  $0.Selector get nextPage => $_getN(17);
  @$pb.TagNumber(30)
  ...
  @$pb.TagNumber(30)
  $core.bool hasNextPage() => $_has(17);
  @$pb.TagNumber(30)
  void clearNextPage() => clearField(30);
  @$pb.TagNumber(30)
  $0.Selector ensureNextPage() => $_ensure(17);

  @$pb.TagNumber(31)
  $0.Selector get idCode => $_getN(18);
  @$pb.TagNumber(31)
  ...
  @$pb.TagNumber(31)
  $core.bool hasIdCode() => $_has(18);
  @$pb.TagNumber(31)
  void clearIdCode() => clearField(31);
  @$pb.TagNumber(31)
  $0.Selector ensureIdCode() => $_ensure(18);

  @$pb.TagNumber(99)
  $core.List<$0.ExtraSelector> get extraSelector => $_getList(19);
}
...
class AutoCompleteParser extends $pb.GeneratedMessage {
  ...
  factory AutoCompleteParser.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AutoCompleteParser.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  AutoCompleteParser copyWith(void Function(AutoCompleteParser) updates) =>
      super.copyWith((message) => updates(message as AutoCompleteParser))
          as AutoCompleteParser; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AutoCompleteParser create() => AutoCompleteParser._();
  AutoCompleteParser createEmptyInstance() => create();
  static $pb.PbList<AutoCompleteParser> createRepeated() =>
      $pb.PbList<AutoCompleteParser>();
  @$core.pragma('dart2js:noInline')
