...
class InputAction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InputAction', createEmptyInstance: create)
    ...
    ..e<InputActionType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: InputActionType.string, valueOf: InputActionType.valueOf, enumValues: InputActionType.values)
