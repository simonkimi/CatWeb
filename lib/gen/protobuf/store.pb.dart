...
class SiteConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SiteConfig', createEmptyInstance: create)
    ...
    ..aOM<RegField>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'loginCookie', subBuilder: RegField.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'upgradeUrl')
    ...
    ..pc<$0.DetailParser>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'detailParsers', $pb.PbFieldType.PM, subBuilder: $0.DetailParser.create)
    ..pc<$0.ListViewParser>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'listViewParsers', $pb.PbFieldType.PM, subBuilder: $0.ListViewParser.create)
    ..pc<$0.ImageParser>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageParsers', $pb.PbFieldType.PM, subBuilder: $0.ImageParser.create)
    ..pc<$0.AutoCompleteParser>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'autoCompleteParsers', $pb.PbFieldType.PM, subBuilder: $0.AutoCompleteParser.create)
    ...
    ..pc<$2.SitePage>(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pages', $pb.PbFieldType.PM, subBuilder: $2.SitePage.create)
    ..hasRequiredFields = false
  ;
