...
class SiteConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SiteConfig', createEmptyInstance: create)
    ...
    ..pc<RegField>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'headers', $pb.PbFieldType.PM, subBuilder: RegField.create)
    ..pc<RegField>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cookies', $pb.PbFieldType.PM, subBuilder: RegField.create)
  ...
  @$pb.TagNumber(8)
  $core.List<RegField> get headers => $_getList(7);

  @$pb.TagNumber(9)
  $core.List<RegField> get cookies => $_getList(8);

  @$pb.TagNumber(10)
  $core.List<$0.GalleryParser> get galleryParsers => $_getList(9);

  @$pb.TagNumber(11)
  $core.List<$0.ListViewParser> get listViewParser => $_getList(10);

  @$pb.TagNumber(12)
  $core.List<$1.ActionCombine> get actionList => $_getList(11);

  @$pb.TagNumber(13)
  $core.List<$2.SitePage> get pageList => $_getList(12);

  @$pb.TagNumber(14)
  $core.List<$0.ImageParser> get imageParsers => $_getList(13);
}
