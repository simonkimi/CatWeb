...
final $typed_data.Uint8List netWorkActionTypeDescriptor = $convert.base64Decode('ChFOZXRXb3JrQWN0aW9uVHlwZRIHCgNHRVQQABIICgRQT1NUEAESBwoDUFVUEAISCgoGREVMRVRFEAM=');
...
final $typed_data.Uint8List inputActionTypeDescriptor = $convert.base64Decode('Cg9JbnB1dEFjdGlvblR5cGUSBwoDTlVNEAASCgoGU1RSSU5HEAE=');
...
const NetWorkAction$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'type', '3': 2, '4': 1, '5': 14, '6': '.NetWorkActionType', '10': 'type'},
...
final $typed_data.Uint8List netWorkActionDescriptor = $convert.base64Decode('Cg1OZXRXb3JrQWN0aW9uEhIKBG5hbWUYASABKAlSBG5hbWUSJgoEdHlwZRgCIAEoDjISLk5ldFdvcmtBY3Rpb25UeXBlUgR0eXBlEhAKA3VybBgDIAEoCVIDdXJsEhIKBGRhdGEYBCABKAlSBGRhdGE=');
