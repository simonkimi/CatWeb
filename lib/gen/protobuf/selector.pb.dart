...
class Selector extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Selector', createEmptyInstance: create)
    ...
    ..e<SelectorFunction>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'function', $pb.PbFieldType.OE, defaultOrMaker: SelectorFunction.auto, valueOf: SelectorFunction.valueOf, enumValues: SelectorFunction.values)
...
class ExtraSelector extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExtraSelector', createEmptyInstance: create)
    ...
    ..e<ExtraSelectorType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: ExtraSelectorType.none, valueOf: ExtraSelectorType.valueOf, enumValues: ExtraSelectorType.values)
    ..hasRequiredFields = false
  ;
