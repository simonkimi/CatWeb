...
final $typed_data.Uint8List pageTemplateDescriptor = $convert.base64Decode('CgxQYWdlVGVtcGxhdGUSDQoJaW1hZ2VMaXN0EAASEgoOaW1hZ2VXYXRlcmZhbGwQARIKCgZkZXRhaWwQAhIPCgtpbWFnZVZpZXdlchAD');
...
const SitePage$json = const {
  ...
  '2': const [
    ...
    const {'1': 'template', '3': 3, '4': 1, '5': 14, '6': '.PageTemplate', '10': 'template'},
    ...
    const {'1': 'openPage', '3': 8, '4': 3, '5': 11, '6': '.OpenPage', '10': 'openPage'},
  ],
};

/// Descriptor for `SitePage`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sitePageDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List openPageDescriptor = $convert.base64Decode('CghPcGVuUGFnZRIWCgZ0YXJnZXQYASABKAlSBnRhcmdldBIYCgdpbmhlcml0GAIgASgIUgdpbmhlcml0');
