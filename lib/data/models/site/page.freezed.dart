...
class _$SitePageCopyWithImpl<$Res, $Val extends SitePage>
  ...
  @pragma('vm:prefer-inline')
  $PageTemplateCopyWith<$Res> get template {
    return $PageTemplateCopyWith<$Res>(_value.template, (value) {
...
class _$SitePageImpl implements _SitePage {
  ...
  _$$SitePageImplCopyWith<_$SitePageImpl> get copyWith =>
      __$$SitePageImplCopyWithImpl<_$SitePageImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$SitePageImplToJson(
      this,
    );
  }
}
...
abstract class _SitePage implements SitePage {
  const factory _SitePage(
      ...
      required final PageTemplate template,
      final String url,
      final SiteNetType action,
      final String formData,
      final String icon,
